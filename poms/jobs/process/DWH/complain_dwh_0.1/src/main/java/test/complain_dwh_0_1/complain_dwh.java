		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:B1MVTo6DO67ES1R3PZDfco3prcmlQPpOkyfXAwbK");
				...
				String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1
						+ "] SET [description] = ?,[status] = ?,[subject] = ?,[code_complaint] = ? WHERE [id_complaint] = ?";
				...
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([id_complaint],[description],[status],[subject],[code_complaint]) VALUES (?,?,?,?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:iTwjprB0pux3Qus8abr9uYvnhSjML5lqjn6pS39EzQ==");
...
// # Output table : 'out'
							...
							out_tmp.code_complaint = "C"
									+ String.format("%02d", Numeric.sequence("seq_complaint", 1, 1));
							out = out_tmp;
// ###############################
...
// Start of branch "out"
						if (out != null) {
							...
							if (out.description == null) {
								...
								pstmtUpdate_tDBOutput_1.setString(1, out.description);
							}

							if (out.status == null) {
								pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmtUpdate_tDBOutput_1.setString(2, out.status);
							}

							if (out.subject == null) {
								pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmtUpdate_tDBOutput_1.setString(3, out.subject);
							}

							if (out.code_complaint == null) {
								pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmtUpdate_tDBOutput_1.setString(4, out.code_complaint);
							}

							if (out.id_complaint == null) {
								pstmtUpdate_tDBOutput_1.setNull(5 + count_tDBOutput_1, java.sql.Types.INTEGER);
							} else {
								pstmtUpdate_tDBOutput_1.setInt(5 + count_tDBOutput_1, out.id_complaint);
							}
							...
							try {
								...
								if (updateFlag_tDBOutput_1 == 0) {
									...
									if (out.id_complaint == null) {
										...
										pstmtInsert_tDBOutput_1.setInt(1, out.id_complaint);
									}

									if (out.description == null) {
										pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(2, out.description);
									}

									if (out.status == null) {
										pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(3, out.status);
									}

									if (out.subject == null) {
										pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(4, out.subject);
									}

									if (out.code_complaint == null) {
										pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(5, out.code_complaint);
									}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = complain_dwh.class.getClassLoader()
					.getResourceAsStream("test/complain_dwh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = complain_dwh.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : complain_dwh");
		}
...
/************************************************************************************************
 * 64549 characters generated by Talend Open Studio for Data Integration on the
 * 17 février 2026, 19:09:58 WAT
 ************************************************************************************************/