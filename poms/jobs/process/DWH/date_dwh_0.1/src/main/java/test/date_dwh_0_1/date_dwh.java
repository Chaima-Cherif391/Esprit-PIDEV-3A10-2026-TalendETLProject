		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:vqplzBCF7uv8pn8wY95UPWu+c+FFsn2c2remeKOY");
				...
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([Date_PK],[Date],[Jour_Moi_Annee],[Annee],[ID_Semestre],[Semestre],[ID_Trimestre],[Trimestre],[ID_Mois],[Mois],[Lib_Mois],[Jour],[Id_Lib_Jour],[Lib_Jour],[Semaine],[JourDeAnnee],[Jour_mois_lettre]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
// ###############################
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					...
					{ // start of Var scope
						...
						Var.date = TalendDate.addDate(TalendDate.parseDate("yyyy-MM-dd", "1990-01-01"), row1.index,
								"dd");
...
// # Filter conditions 
						...
						Var.annee >= 1990 && Var.annee <= 2050
							...
							out1_tmp.Jour_Moi_Annee = new java.text.SimpleDateFormat("d - MMMM - yyyy",
									java.util.Locale.FRENCH).format(Var.date);
							out1_tmp.Annee = Var.annee;
							out1_tmp.ID_Semestre = String.valueOf(Var.annee) + " Semestre "
									+ String.valueOf(Var.semestre);
							out1_tmp.Semestre = "Semestre " + String.valueOf(Var.semestre);
							out1_tmp.ID_Trimestre = String.valueOf(Var.annee) + " Trimestre "
									+ String.valueOf(Var.trimestre);
							...
							out1_tmp.Lib_Mois = new java.text.SimpleDateFormat("MMMM", java.util.Locale.FRENCH)
									.format(Var.date);
							out1_tmp.Jour = Var.jour;
							out1_tmp.Id_Lib_Jour = Integer.parseInt(TalendDate.formatDate("u", Var.date));
							out1_tmp.Lib_Jour = new java.text.SimpleDateFormat("EEEE", java.util.Locale.FRENCH)
									.format(Var.date);
							...
							out1_tmp.Jour_mois_lettre = new java.text.SimpleDateFormat("EEEE - d - MMMM",
									java.util.Locale.FRENCH).format(Var.date);
							out1 = out1_tmp;
...
// Start of branch "out1"
					if (out1 != null) {
						...
						if (out1.Date_PK == null) {
							...
							pstmt_tDBOutput_1.setInt(1, out1.Date_PK);
						}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = date_dwh.class.getClassLoader()
					.getResourceAsStream("test/date_dwh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = date_dwh.class.getClassLoader()
...
/************************************************************************************************
 * 64256 characters generated by Talend Open Studio for Data Integration on the
 * 23 février 2026, 22:12:56 WAT
 ************************************************************************************************/