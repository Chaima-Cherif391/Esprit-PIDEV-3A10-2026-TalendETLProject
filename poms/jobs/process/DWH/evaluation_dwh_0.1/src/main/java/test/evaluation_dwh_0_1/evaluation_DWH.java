		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:p8mUv13T+nN0RI0UvAGLpLCkffXNvXClB4D1t8OV");
				...
				String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1
						+ "] SET [rating] = ?,[comment] = ?,[code_evaluation] = ? WHERE [id_evaluation] = ?";
				...
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([id_evaluation],[rating],[comment],[code_evaluation]) VALUES (?,?,?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:LBE57OaS1bZQD99XwehNker4bk30UqDkYUjggoRsZA==");
...
// # Output table : 'out'
							...
							out_tmp.code_evaluation = "E"
									+ String.format("%02d", Numeric.sequence("seq_evaluation", 1, 1));
							out = out_tmp;
// ###############################
...
// Start of branch "out"
						if (out != null) {
							...
							if (out.rating == null) {
								...
								pstmtUpdate_tDBOutput_1.setInt(1, out.rating);
							}

							if (out.comment == null) {
								pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmtUpdate_tDBOutput_1.setString(2, out.comment);
							}

							if (out.code_evaluation == null) {
								pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmtUpdate_tDBOutput_1.setString(3, out.code_evaluation);
							}

							if (out.id_evaluation == null) {
								pstmtUpdate_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.INTEGER);
							} else {
								pstmtUpdate_tDBOutput_1.setInt(4 + count_tDBOutput_1, out.id_evaluation);
							}
							...
							try {
								...
								if (updateFlag_tDBOutput_1 == 0) {
									...
									if (out.id_evaluation == null) {
										...
										pstmtInsert_tDBOutput_1.setInt(1, out.id_evaluation);
									}

									if (out.rating == null) {
										pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
									} else {
										pstmtInsert_tDBOutput_1.setInt(2, out.rating);
									}

									if (out.comment == null) {
										pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(3, out.comment);
									}

									if (out.code_evaluation == null) {
										pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(4, out.code_evaluation);
									}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = evaluation_DWH.class.getClassLoader()
					.getResourceAsStream("test/evaluation_dwh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 62187 characters generated by Talend Open Studio for Data Integration on the
 * 17 février 2026, 19:01:35 WAT
 ************************************************************************************************/