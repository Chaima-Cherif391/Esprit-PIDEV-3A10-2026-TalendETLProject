		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:ItAW0qP+FeqokBDCn9aknc0E1mu/hRLDmc6Jt2pD");
				...
				String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1
						+ "] SET [title] = ?,[type] = ?,[event_date] = ? WHERE [id_event] = ?";
				...
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([id_event],[title],[type],[event_date]) VALUES (?,?,?,?)";
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:SIJUn0e6UCpUn85hf8ruA1EQ1iJk78pzb2vxOC9U1g==");
...
// # Output table : 'out'
							...
							out_tmp.event_date = (row1.event_date == null || row1.event_date.trim().isEmpty()) ? null
									: (row1.event_date.trim().matches("\\d+") ? new java.util.Date(
											(long) (Integer.parseInt(row1.event_date.trim()) - 25569) * 86400000L)
											: new java.util.Date(
													new java.text.SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy",
															java.util.Locale.ENGLISH).parse(row1.event_date.trim())
																	.getTime()));
							out = out_tmp;
// ###############################
...
// Start of branch "out"
						if (out != null) {
							...
							if (out.title == null) {
								...
								pstmtUpdate_tDBOutput_1.setString(1, out.title);
							}

							if (out.type == null) {
								pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmtUpdate_tDBOutput_1.setString(2, out.type);
							}

							if (out.event_date != null) {
								pstmtUpdate_tDBOutput_1.setTimestamp(3,
										new java.sql.Timestamp(out.event_date.getTime()));
							} else {
							...
							if (out.id_event == null) {
								...
								pstmtUpdate_tDBOutput_1.setInt(4 + count_tDBOutput_1, out.id_event);
							}
							...
							try {
								...
								if (updateFlag_tDBOutput_1 == 0) {
									...
									if (out.id_event == null) {
										...
										pstmtInsert_tDBOutput_1.setInt(1, out.id_event);
									}

									if (out.title == null) {
										pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(2, out.title);
									}

									if (out.type == null) {
										pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(3, out.type);
									}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = event_dwh.class.getClassLoader()
					.getResourceAsStream("test/event_dwh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = event_dwh.class.getClassLoader()
...
/************************************************************************************************
 * 63734 characters generated by Talend Open Studio for Data Integration on the
 * 22 février 2026, 01:57:08 WAT
 ************************************************************************************************/