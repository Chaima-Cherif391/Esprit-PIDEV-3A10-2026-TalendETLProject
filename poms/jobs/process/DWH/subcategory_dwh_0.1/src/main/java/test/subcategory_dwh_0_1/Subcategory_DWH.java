		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:DSkETPI5QMcYGis+yUpGZt4dH0olPu+k+sHKbPql");
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:quVVHfMfWiwaZbtwDHDcV3bBIsOt7+hz8DCEV5F4sg==");
...
// Start of branch "out"
						if (out != null) {
							...
							if (out.name == null) {
								...
								pstmtUpdate_tDBOutput_1.setString(1, out.name);
							}

							if (out.id_subcategory == null) {
								pstmtUpdate_tDBOutput_1.setNull(2 + count_tDBOutput_1, java.sql.Types.INTEGER);
							} else {
								pstmtUpdate_tDBOutput_1.setInt(2 + count_tDBOutput_1, out.id_subcategory);
							}
							...
							try {
								...
								if (updateFlag_tDBOutput_1 == 0) {
									...
									if (out.id_subcategory == null) {
										...
										pstmtInsert_tDBOutput_1.setInt(1, out.id_subcategory);
									}

									if (out.name == null) {
										pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(2, out.name);
									}
...
// ###############################      
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Subcategory_DWH.class.getClassLoader()
					.getResourceAsStream("test/subcategory_dwh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Subcategory_DWH.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Subcategory_DWH");
		}
...
/************************************************************************************************
 * 60545 characters generated by Talend Open Studio for Data Integration on the
 * 2 mars 2026, 13:44:12 WAT
 ************************************************************************************************/