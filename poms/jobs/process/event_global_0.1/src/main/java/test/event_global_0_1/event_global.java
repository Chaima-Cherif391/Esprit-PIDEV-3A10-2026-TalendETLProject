 ...
 * @status
 */
public class event_global implements TalendJob {
	...
	private final String jobName = "event_global";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(event_global.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TEST_event_global = new byte[0];
		static byte[] commonByteArray_TEST_event_global = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_event_global.length) {
					if (length < 1024 && commonByteArray_TEST_event_global.length == 0) {
						commonByteArray_TEST_event_global = new byte[1024];
					} else {
						commonByteArray_TEST_event_global = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_event_global, 0, length);
				strReturn = new String(commonByteArray_TEST_event_global, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TEST_event_global, 0, length);
				strReturn = new String(commonByteArray_TEST_event_global, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_event_global) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:GeaG2HzH9MP1Kr/bl5ksGpVwVd7deMViWPyEdW2AfQ==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "events_global";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "events_global";
				}
				int count_tDBOutput_1 = 0;

				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([category],[event_name],[event_date],[city],[country],[price],[source],[scraping_date]) VALUES (?,?,?,?,?,?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:OMP1RBTb35HKEygNQavueEQISeJUL+96S0D9hw==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/user/OneDrive - ESPRIT/Bureau/4BI/PA_BI/events_global_fusion.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "event_name";

									row1.event_name = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "scraping_date";

									row1.scraping_date = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.category == null) {
									...
									pstmt_tDBOutput_1.setString(1, row1.category);
								}

								if (row1.event_name == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, row1.event_name);
								}

								if (row1.event_date == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.event_date);
								}
								...
								if (row1.country == null) {
									...
									pstmt_tDBOutput_1.setString(5, row1.country);
								}

								if (row1.price == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(6, row1.price);
								}

								if (row1.source == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(7, row1.source);
								}

								if (row1.scraping_date == null) {
									pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(8, row1.scraping_date);
								}
	...
	public static void main(String[] args) {
		final event_global event_globalClass = new event_global();

		int exitCode = event_globalClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = event_global.class.getClassLoader()
					.getResourceAsStream("test/event_global_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = event_global.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : event_global");
		}
...
/************************************************************************************************
 * 62020 characters generated by Talend Open Studio for Data Integration on the
 * 8 février 2026, 17:40:58 WAT
 ************************************************************************************************/