 ...
 * @status
 */
public class meteo implements TalendJob {
	...
	private final String jobName = "meteo";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(meteo.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TEST_meteo = new byte[0];
		static byte[] commonByteArray_TEST_meteo = new byte[0];
		...
		public Float pressure_mean;

		public Float getPressure_mean() {
			return this.pressure_mean;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_meteo.length) {
					if (length < 1024 && commonByteArray_TEST_meteo.length == 0) {
						commonByteArray_TEST_meteo = new byte[1024];
					} else {
						commonByteArray_TEST_meteo = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_meteo, 0, length);
				strReturn = new String(commonByteArray_TEST_meteo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TEST_meteo, 0, length);
				strReturn = new String(commonByteArray_TEST_meteo, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_meteo) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.pressure_mean = null;
					} else {
						this.pressure_mean = dis.readFloat();
					}
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.pressure_mean == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
					dos.writeFloat(this.pressure_mean);
				}
		...
		public String toString() {
			...
			sb.append(",saison=" + String.valueOf(saison));
			...
			sb.append(",pressure_mean=" + String.valueOf(pressure_mean));
			sb.append("]");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:naeK+Drq5gOxZjp7looCSvRuNHo+3lCtdOpzWNOSJw==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "meteo";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "meteo";
				}
				...
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([ville],[date],[annee],[mois],[jour],[saison],[saison_nom],[condition_meteo],[weather_code],[temp_max],[temp_min],[precipitation],[wind_speed_max],[humidity_mean],[pressure_mean]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:Y2uQ8axgFwIgnY+qnGvGUvO6crbf2BYOLFZbcA==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/user/OneDrive - ESPRIT/Bureau/4BI/PA_BI/other Scrapping/meteo_tunisie_2022_2025_avec_conditions.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									row1.saison = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "saison_nom";

									row1.saison_nom = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "condition_meteo";

									row1.condition_meteo = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "weather_code";

									row1.weather_code = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "temp_max";

									row1.temp_max = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "temp_min";

									row1.temp_min = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "precipitation";

									row1.precipitation = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "wind_speed_max";

									row1.wind_speed_max = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "humidity_mean";

									row1.humidity_mean = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "pressure_mean";

									row1.pressure_mean = ParserUtils.parseTo_Float(ParserUtils.parseTo_Number(
											temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1], null,
											'.' == decimalChar_tFileInputExcel_1 ? null
													: decimalChar_tFileInputExcel_1));
								} else {
									row1.pressure_mean = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.annee == null) {
									...
									pstmt_tDBOutput_1.setInt(3, row1.annee);
								}

								if (row1.mois == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(4, row1.mois);
								}

								if (row1.jour == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(5, row1.jour);
								}

								if (row1.saison == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(6, row1.saison);
								}

								if (row1.saison_nom == null) {
									pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(7, row1.saison_nom);
								}

								if (row1.condition_meteo == null) {
									pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(8, row1.condition_meteo);
								}

								if (row1.weather_code == null) {
									pstmt_tDBOutput_1.setNull(9, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(9, row1.weather_code);
								}

								if (row1.temp_max == null) {
									pstmt_tDBOutput_1.setNull(10, java.sql.Types.FLOAT);
								} else {
									pstmt_tDBOutput_1.setFloat(10, row1.temp_max);
								}

								if (row1.temp_min == null) {
									pstmt_tDBOutput_1.setNull(11, java.sql.Types.FLOAT);
								} else {
									pstmt_tDBOutput_1.setFloat(11, row1.temp_min);
								}

								if (row1.precipitation == null) {
									pstmt_tDBOutput_1.setNull(12, java.sql.Types.FLOAT);
								} else {
									pstmt_tDBOutput_1.setFloat(12, row1.precipitation);
								}

								if (row1.wind_speed_max == null) {
									pstmt_tDBOutput_1.setNull(13, java.sql.Types.FLOAT);
								} else {
									pstmt_tDBOutput_1.setFloat(13, row1.wind_speed_max);
								}

								if (row1.humidity_mean == null) {
									pstmt_tDBOutput_1.setNull(14, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(14, row1.humidity_mean);
								}

								if (row1.pressure_mean == null) {
									pstmt_tDBOutput_1.setNull(15, java.sql.Types.FLOAT);
								} else {
									pstmt_tDBOutput_1.setFloat(15, row1.pressure_mean);
								}
	...
	public static void main(String[] args) {
		final meteo meteoClass = new meteo();

		int exitCode = meteoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = meteo.class.getClassLoader()
					.getResourceAsStream("test/meteo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = meteo.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : meteo");
		}
...
/************************************************************************************************
 * 78837 characters generated by Talend Open Studio for Data Integration on the
 * 2 mars 2026, 00:04:38 WAT
 ************************************************************************************************/