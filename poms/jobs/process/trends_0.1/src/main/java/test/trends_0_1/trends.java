 ...
 * @status
 */
public class trends implements TalendJob {
	...
	private final String jobName = "trends";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(trends.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_TEST_trends = new byte[0];
		static byte[] commonByteArray_TEST_trends = new byte[0];
		...
		public String growth_rate_;

		public String getGrowth_rate_() {
			return this.growth_rate_;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TEST_trends.length) {
					if (length < 1024 && commonByteArray_TEST_trends.length == 0) {
						commonByteArray_TEST_trends = new byte[1024];
					} else {
						commonByteArray_TEST_trends = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TEST_trends, 0, length);
				strReturn = new String(commonByteArray_TEST_trends, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TEST_trends, 0, length);
				strReturn = new String(commonByteArray_TEST_trends, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TEST_trends) {
				...
				try {
					...
					this.growth_rate_ = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.growth_rate_, dos);
		...
		public String toString() {
			...
			sb.append(",growth_rate_=" + growth_rate_);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:MGOe6uttNiTVn0zqSTIDR8PgH6u/JkhvuflWowivdA==");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "trends";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "trends";
				}
				...
				if (!whetherExist_tDBOutput_1) {
					try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
						stmtCreate_tDBOutput_1.execute("CREATE TABLE [" + tableName_tDBOutput_1
								+ "]([id_trend] INT ,[keyword] VARCHAR(20)  ,[category] VARCHAR(9)  ,[trend_score] VARCHAR(28)  ,[growth_rate_] VARCHAR(28)  ,[year] INT )");
					}
				}
				String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1
						+ "] ([id_trend],[keyword],[category],[trend_score],[growth_rate_],[year]) VALUES (?,?,?,?,?,?)";
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:XuznfSbydUQTLn3wqJaf8YKRc53SumVbJpP48g==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/user/OneDrive - ESPRIT/Bureau/4BI/PA_BI/other Scrapping/EVENT_TRENDS_FINAL.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									...
									curColName_tFileInputExcel_1 = "id_trend";

									row1.id_trend = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "keyword";

									row1.keyword = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.keyword = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "trend_score";

									row1.trend_score = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "growth_rate_";

									row1.growth_rate_ = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1];
								} else {
									row1.growth_rate_ = null;
									emptyColumnCount_tFileInputExcel_1++;
								}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								if (row1.id_trend == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(1, row1.id_trend);
								}

								if (row1.keyword == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, row1.keyword);
								}

								if (row1.category == null) {
									pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(3, row1.category);
								}

								if (row1.trend_score == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, row1.trend_score);
								}

								if (row1.growth_rate_ == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, row1.growth_rate_);
								}

								if (row1.year == null) {
									pstmt_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
								} else {
									pstmt_tDBOutput_1.setInt(6, row1.year);
								}
	...
	public static void main(String[] args) {
		final trends trendsClass = new trends();

		int exitCode = trendsClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = trends.class.getClassLoader()
					.getResourceAsStream("test/trends_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = trends.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : trends");
		}
